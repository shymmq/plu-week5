# coding: utf-8
# generated by sqlacodegen from northwind.postgre.sql
from sqlalchemy import Column, Date, Float, Integer, LargeBinary, SmallInteger, String, Table, Text, ForeignKey
